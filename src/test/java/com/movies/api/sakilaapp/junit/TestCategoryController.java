...
class TestCategoryController {
    ...
    CategoryController mockApp = new CategoryController(actorRepository, filmRespository, categoryRepository, filmActorRepository, categoryFilmRepository, stockRepository);
